...
<!-- Mirrored from htmlbeans.com/html/schon/order-shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Apr 2023 13:56:43 GMT -->
<head>
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12 col-sm-6 hidden-xs">
                <span class="tel"> <i class="fa fa-phone" aria-hidden="true"></i>  (888) 01715678901</span>
              </div>
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="mt-bottom-bar">
                ...
                <div class="mt-logo"><a href="#"><img src="images/Finallogo.png" alt="gadgetgalaxy"style="width: 100px; height: auto;"></a></div>
        ...
        <div class="mt-product-table">
          <div class="container">
            ...
            <div class="row border">
              <div class="col-xs-12 col-sm-2">
                <div class="img-holder">
                  <img src="images/products/phone4.jpeg" alt="image description">
                </div>
              </div>
              <div class="col-xs-12 col-sm-4">
                <strong class="product-name">Vivo Y22</strong>
              </div>
              <div class="col-xs-12 col-sm-2">
                <strong class="price"> 20990</strong>
              </div>
              <div class="col-xs-12 col-sm-2">
            ...
            <div class="row border">
              <div class="col-xs-12 col-sm-2">
                <div class="img-holder">
                  <img src="images/products/airbuds3.png" alt="image description">
                </div>
              </div>
              <div class="col-xs-12 col-sm-4">
                <strong class="product-name">Audionic Airbud 500</strong>
              </div>
              <div class="col-xs-12 col-sm-2">
                <strong class="price"> 3899</strong>
              </div>
              <div class="col-xs-12 col-sm-2">
                <form action="#" class="qyt-form">
                  <fieldset>
