...
<body>
            ...
            <div class="col-xs-12 col-sm-10 col-sm-push-1">
                <div class="holder" style="margin: 0;">
                    <div class="mt-side-widget">
                        <header>
                            <h2 style="margin: 0 0 5px;">Payment Option</h2>
                        </header>
                        <fieldset>
        <div class="payment-options">
            <div class="payment-method">
                <input type="radio" id="bkash" name="paymentMethod" value="bkash">
                <label for="bkash" class="method-name">bKash</label>
                <p class="method-description">Pay via bKash mobile financial service.</p>
            </div>
            <div class="payment-method">
                <input type="radio" id="rocket" name="paymentMethod" value="rocket">
                <label for="rocket" class="method-name">Rocket</label>
                <p class="method-description">Pay via Rocket mobile financial service.</p>
            </div>
            <div class="payment-method">
                <input type="radio" id="nagad" name="paymentMethod" value="nagad">
                <label for="nagad" class="method-name">Nagad</label>
                <p class="method-description">Pay via Nagad mobile financial service.</p>
            </div>
            <div class="payment-method">
                <input type="radio" id="bank" name="paymentMethod" value="bank">
                <label for="bank" class="method-name">Bank Transfer</label>
                <p class="method-description">Pay via bank transfer to the provided account.</p>
            </div>
            <div class="payment-method">
                <input type="radio" id="bank" name="paymentMethod" value="bank">
                <label for="bank" class="method-name">Cash On Delivary</label>
                <p class="method-description">Pay cash upon delivery of your order.</p>
            </div>
        </div>
        <!-- Next button -->
  ...
  <script>
        ...
        if (selectedMethod === "bkash") {
            window.location.href = "https://www.bkash.com/"; // Redirect to bKash website
        } else if (selectedMethod === "rocket") {
            window.location.href = "https://dutchbanglabank.com/";

          } else if (selectedMethod === "nagad") {
            window.location.href = "https://nagad.com.bd";

            } else if (selectedMethod === "bank") {
                window.location.href = "bankpayment.php"; // Redirect to payment.php
            }
            // Add conditions for other payment methods as needed
        }
    </script>
