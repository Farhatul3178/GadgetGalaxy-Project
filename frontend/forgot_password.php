      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-push-2">
          <div class="forgot-password-holder">
            ...
            <p class="forgot-password-instructions">Enter your email address below and we'll send you instructions on how to reset your password.</p>
            ...
            <form id="forgotPasswordForm" action="reset_password.php" method="post">
              ...
              <div class="centered-button">
                <button type="submit" class="btn btn-primary rounded-pill btn-submit" name="submit">Reset Password</button>
              </div>
              <!-- Space -->
